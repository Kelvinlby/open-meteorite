package addon.kelvinlby.openmeteorite.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(OpenMeteorite.HUD_GROUP, "example", "HUD element example.", HudExample::new);
